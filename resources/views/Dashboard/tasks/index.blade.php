...
@section('adminContent')
    ...
    <form id="import" class="form_class m-3" style="display: inline-block" action="{{ route('tasks.import') }}" method="POST"
        enctype="multipart/form-data">
        @csrf
        <input class="form-control form-control-sm import-tasks" form="import" type="file" name="file"
            accept="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet" data-buttonText="{{ __('Import') }}"
            required />
    </form>
                                        ...
                                        <td class="align-middle py-2" style="width: 28px;">
                                            <div class="form-check fs-0 mb-0 d-flex align-items-center">
                                                <input class="form-check-input" name="items[]"
                                                    value="{{ $task->id }}" type="checkbox" id="customer-0"
